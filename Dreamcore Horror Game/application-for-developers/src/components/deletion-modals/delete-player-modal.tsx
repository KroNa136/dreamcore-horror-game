...
import { deletePlayer } from '../../requests';
...
export default function DeletePlayerModal(props: DeletePlayerModalProps) {
  const handleDelete = () => {
      ...
      <Fade in={props.open}>
        <Box sx={{
          ...
          <Typography id="modal-modal-description" sx={{ mt: 2 }}>
            Вы точно хотите удалить игрока {displayName(props.player)}?
          </Typography>
