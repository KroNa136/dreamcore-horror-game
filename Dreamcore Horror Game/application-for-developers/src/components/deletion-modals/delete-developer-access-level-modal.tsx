...
import { deleteDeveloperAccessLevel } from "../../requests";

interface DeleteDeveloperAccessLevelModalProps {
  open: boolean,
...
export default function DeleteDeveloperAccessLevelModal(props: DeleteDeveloperAccessLevelModalProps) {
  const handleDelete = () => {
    deleteDeveloperAccessLevel(props.developerAccessLevel.id)
      .then(success => {
        if (success === true) {
          props.setOpen(false);
          props.onDelete();
