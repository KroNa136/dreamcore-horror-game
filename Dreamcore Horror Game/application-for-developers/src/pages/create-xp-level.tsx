...
import { createXpLevel } from "../requests";
...
export default function CreateXpLevel() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const createdXpLevel: XpLevel | undefined = await createXpLevel(newXpLevel);

    if (createdXpLevel) {
      navigate(`/xpLevel/${createdXpLevel.id}`);
    }
  };
